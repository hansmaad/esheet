...
async function fetchData() {
    ...
    const rows = csv.split("\n").map(parseCSVLine).map((row)=>row.slice(0, 8)).filter((row)=>row[0]);
    return rows;
}
...
function chart(csv) {
    const chartElement = (0, _chart.createChart)(csv);
...
function parseCSVLine(line) {
    ...
    for(let i = 0; i < line.length; ++i){
        ...
        if (quoted) {
            if (c === '"') quoted = false;
            else values[values.length - 1] += c;
        } else {
            if (c === '"') quoted = true;
            else if (c === ",") values.push("");
        }
    }
    return values;
}

},{"./chart":"dF3Ha"}],"dF3Ha":[function(require,module,exports) {
...
},{"chartist":"6jrAo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6jrAo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire1f2a")
